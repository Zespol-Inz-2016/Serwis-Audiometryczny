...
namespace SerwisAudiometryczny.Controllers.ModelsControllers
{
    public class AudiogramModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,PatientID,DictDiagnosisModelID,DictSexModelID,DictNuisanceModelID,DictInstrumentModelID,IsMusican,PercentageHearingLoss,PatientAge,CreationDate,Type")] AudiogramModel audiogramModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,PatientID,DictDiagnosisModelID,DictSexModelID,DictNuisanceModelID,DictInstrumentModelID,IsMusican,PercentageHearingLoss,PatientAge,CreationDate,Type")] AudiogramModel audiogramModel)
        {
            if (ModelState.IsValid)
            {
